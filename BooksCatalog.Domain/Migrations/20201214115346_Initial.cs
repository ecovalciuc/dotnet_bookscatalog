    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LocationBooks", x => x.Id);
                    table.ForeignKey(
                        name: "FK_LocationBooks_Books_BookId",
                        column: x => x.BookId,
                        principalTable: "Books",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_LocationBooks_Locations_LocationId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LocationBooks_BookId",
                table: "LocationBooks",
                column: "BookId");

            migrationBuilder.CreateIndex(
                name: "IX_LocationBooks_LocationId",
                table: "LocationBooks",
                column: "LocationId");
        }
